...
2. B: Print it to a scale of 2 decimal places, preceded by a + or - sign (indicating if it's positive or negative), right justified, and left-padded with underscores so that the printed result is exactly 16 characters wide.
...
For the first line of output, (100)base10 -> (64)base16  (in reverse, 6 x 16^1 + 4 x 16^0 = (100)base10 ). 
